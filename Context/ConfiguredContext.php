 ...
 */
class ConfiguredContext implements DefaultContextInterface, DefaultContextOptionsInterface
{
    /**
    ...
    {
        if ($isSearchTermQuery) {
            return $this->config->getDefaultSortsForSearchTermQuery();
        }
